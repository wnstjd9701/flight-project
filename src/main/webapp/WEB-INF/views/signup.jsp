	...
	<div class="sign-div">
		<div class="agree">
			...
			<div class="agree-con">
				...
				<div class="agree-con-t">
					<h6>
						...
						주식회사 5늘 떠나조(전자상거래 사업자)가 운영하는 항공권 예약flightEasy(이하 “몰”이라 한다)에서 제공하는 인터넷 관련
						...
						신청하실 수 있으며, flightEasy는 이에 대한 승낙을 통해 회원 가입 절차를 완료하고 여러분께 flightEasy 서비스 이용 계정(이하
						‘계정’)을 부여합니다. 계정이란 회원이 flightEasy 서비스에 로그인한 이후 이용하는 각종 서비스 이용 이력을 회원 별로
			...
			<div class="agree-con">
				...
				<div class="agree-con-t">
					<h6>
						<span style="line-height: 4em;"> 제1조(목적)</span> <br>
						1. 개인정보 수집목적 및 이용목적 가. 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산 콘텐츠 제공 ,
						구매 및 요금 결제 , 물품배송 또는 청구지 등 발송 , 금융거래 본인 인증 및 금융 서비스 <br> <br>
						2. 수집한 개인정보의 이용 flightEasy 및 flightEasy관련 제반 서비스(모바일 웹/앱 포함)의 회원관리, 서비스 개발・제공 및
						...
						있으며, flightEasy는 이에 대한 승낙을 통해 회원 가입 절차를 완료하고 여러분께 flightEasy 서비스 이용 계정(이하 ‘계정’)을
						부여합니다. 계정이란 회원이 flightEasy 서비스에 로그인한 이후 이용하는 각종 서비스 이용 이력을 회원 별로 관리하기 위해
			...
			<div class="agree-con">
				...
				<div class="agree-con-t">
					<h6>
						...
						이벤트, 신상품 소식 등 쇼핑몰에서 제공하는 유익한 정보를 SMS와 이메일로 받아보실 수 있습니다. 단, 주문/거래
						...
						<br> 여러분은 본 약관을 읽고 동의하신 후 회원 가입을 신청하실 수 있으며, flightEasy는 이에 대한 승낙을
						...
						계정 운영정책 및 고객센터 내 flightEasy 회원가입 방법 등에서 확인해 주세요.
					</h6>
				</div>
				<h6>
