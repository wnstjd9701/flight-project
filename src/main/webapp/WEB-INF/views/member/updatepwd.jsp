								...
								<section class="updatepw">
									<div class="col-lg-12">
										...
										<form action="<c:url value='/member/updatepw'/>" method="post">
											기존 비밀번호<input class="long" name="password" type="password"
												placeholder="비밀번호확인"><br> 변경할 비밀번호<input
												type="password" class="cb1">아이디 저장 <br> <input
												type="submit" value="변경"><br>
										</form>
									</div>
								</section>
							</div>
