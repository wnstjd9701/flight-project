		...
		<div class="container">
			<div class="pg-opt">
				<div class="row">
					<div class="col-md-6 pc">
						<h2>
							<fmt:message key="UPDATE_ARTICLE" />
						</h2>
					</div>
					<div class="col-md-6">
						<ol class="breadcrumb">
			...
			<div class="content">
				<form action="<c:url value='/board/update'/>" method="post"
								...
								<select name="categoryId" id="categoryId" class="form-control"
									...
									<c:forEach var="category" items="${categoryList}">
										<option value="${category.categoryId}"
											${category.categoryId eq board.categoryId ? "selected" : ""}>${category.boardCategoryName}</option>
									</c:forEach>
								</select>
							</div>
						</div>
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="memberId"><fmt:message
								key="WRITER" /></label>
						<div class="col-sm-2">
							<input type="text" name="memberId" id="memberId"
								class="form-control" value="${board.memberId}" readonly>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-2" for="title"><fmt:message
								key="TITLE" /></label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="content"><fmt:message
								key="CONTENT" /></label>
						<div class="col-sm-8">
